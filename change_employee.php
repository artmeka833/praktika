...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $patro = $_POST['patro'];
    $rank = $_POST['rank'];
    $sql = "UPDATE employee SET surname=?, name=?, patro=?, rank=? WHERE id=?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssi", $surname, $name, $patro, $rank, $id);
...
<body>
    <div class="wrapper">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            <div class="input-box">
                <input type="text" id="rank" name="rank" value="<?php echo $class['rank'];?>" required><br>
            </div>
